...
defmodule Microsoft.Azure.Management.Compute.Model.VirtualMachineScaleSetIpConfigurationProperties do
  @moduledoc """
...
defimpl Poison.Decoder, for: Microsoft.Azure.Management.Compute.Model.VirtualMachineScaleSetIpConfigurationProperties do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:"publicIPAddressConfiguration", :struct, Microsoft.Azure.Management.Compute.Model.VirtualMachineScaleSetPublicIpAddressConfiguration, options)
