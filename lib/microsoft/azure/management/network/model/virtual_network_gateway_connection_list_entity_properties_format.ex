...
defmodule Microsoft.Azure.Management.Network.Model.VirtualNetworkGatewayConnectionListEntityPropertiesFormat do
  @moduledoc """
...
defimpl Poison.Decoder, for: Microsoft.Azure.Management.Network.Model.VirtualNetworkGatewayConnectionListEntityPropertiesFormat do
  import Microsoft.Azure.Management.Network.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"virtualNetworkGateway1", :struct, Microsoft.Azure.Management.Network.Model.VirtualNetworkConnectionGatewayReference, options)
    |> deserialize(:"virtualNetworkGateway2", :struct, Microsoft.Azure.Management.Network.Model.VirtualNetworkConnectionGatewayReference, options)
    |> deserialize(:"localNetworkGateway2", :struct, Microsoft.Azure.Management.Network.Model.VirtualNetworkConnectionGatewayReference, options)
