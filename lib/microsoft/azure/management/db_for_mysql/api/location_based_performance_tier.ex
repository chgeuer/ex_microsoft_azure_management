...
defmodule Microsoft.Azure.Management.DbForMysql.Api.LocationBasedPerformanceTier do
  @moduledoc """
  ...
  {:ok, %Microsoft.Azure.Management.DbForMysql.Model.PerformanceTierListResult{}} on success
  {:error, info} on failure
  """
  @spec location_based_performance_tier_list(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, Microsoft.Azure.Management.DbForMysql.Model.PerformanceTierListResult.t} | {:error, Tesla.Env.t}
  def location_based_performance_tier_list(connection, api_version, subscription_id, location_name, _opts \\ []) do
    ...
    |> decode(%Microsoft.Azure.Management.DbForMysql.Model.PerformanceTierListResult{})
  end
end
