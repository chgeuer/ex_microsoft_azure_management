...
defmodule Microsoft.Azure.Management.DbForMysql.Api.Servers do
  @moduledoc """
  ...
  {:ok, %Microsoft.Azure.Management.DbForMysql.Model.Server{}} on success
  {:error, info} on failure
  """
  @spec servers_create(Tesla.Env.client, String.t, String.t, String.t, String.t, Microsoft.Azure.Management.DbForMysql.Model.ServerForCreate.t, keyword()) :: {:ok, Microsoft.Azure.Management.DbForMysql.Model.Server.t} | {:error, Tesla.Env.t}
  def servers_create(connection, api_version, subscription_id, resource_group_name, server_name, parameters, _opts \\ []) do
    ...
    |> decode(%Microsoft.Azure.Management.DbForMysql.Model.Server{})
  end
  ...
  {:error, info} on failure
  """
  @spec servers_get(Tesla.Env.client, String.t, String.t, String.t, String.t, keyword()) :: {:ok, Microsoft.Azure.Management.DbForMysql.Model.Server.t} | {:error, Tesla.Env.t}
  ...
  {:ok, %Microsoft.Azure.Management.DbForMysql.Model.ServerListResult{}} on success
  {:error, info} on failure
  """
  @spec servers_list(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, Microsoft.Azure.Management.DbForMysql.Model.ServerListResult.t} | {:error, Tesla.Env.t}
  def servers_list(connection, api_version, subscription_id, _opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%Microsoft.Azure.Management.DbForMysql.Model.ServerListResult{})
  end
  ...
  {:error, info} on failure
  """
  @spec servers_list_by_resource_group(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, Microsoft.Azure.Management.DbForMysql.Model.ServerListResult.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec servers_update(Tesla.Env.client, String.t, String.t, String.t, String.t, Microsoft.Azure.Management.DbForMysql.Model.ServerUpdateParameters.t, keyword()) :: {:ok, Microsoft.Azure.Management.DbForMysql.Model.Server.t} | {:error, Tesla.Env.t}
