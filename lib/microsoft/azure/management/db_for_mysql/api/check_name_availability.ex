...
defmodule Microsoft.Azure.Management.DbForMysql.Api.CheckNameAvailability do
  @moduledoc """
  ...
  {:ok, %Microsoft.Azure.Management.DbForMysql.Model.NameAvailability{}} on success
  {:error, info} on failure
  """
  @spec check_name_availability_execute(Tesla.Env.client, String.t, String.t, Microsoft.Azure.Management.DbForMysql.Model.NameAvailabilityRequest.t, keyword()) :: {:ok, Microsoft.Azure.Management.DbForMysql.Model.NameAvailability.t} | {:error, Tesla.Env.t}
  def check_name_availability_execute(connection, api_version, subscription_id, name_availability_request, _opts \\ []) do
    ...
    |> decode(%Microsoft.Azure.Management.DbForMysql.Model.NameAvailability{})
  end
end
