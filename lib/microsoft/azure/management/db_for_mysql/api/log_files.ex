...
defmodule Microsoft.Azure.Management.DbForMysql.Api.LogFiles do
  @moduledoc """
  ...
  {:ok, %Microsoft.Azure.Management.DbForMysql.Model.LogFileListResult{}} on success
  {:error, info} on failure
  """
  @spec log_files_list_by_server(Tesla.Env.client, String.t, String.t, String.t, String.t, keyword()) :: {:ok, Microsoft.Azure.Management.DbForMysql.Model.LogFileListResult.t} | {:error, Tesla.Env.t}
  def log_files_list_by_server(connection, api_version, subscription_id, resource_group_name, server_name, _opts \\ []) do
    %{}
    |> method(:get)
    |> url("/subscriptions/#{subscription_id}/resourceGroups/#{resource_group_name}/providers/Microsoft.DBforMySQL/servers/#{server_name}/logFiles")
    |> add_param(:query, :"api-version", api_version)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%Microsoft.Azure.Management.DbForMysql.Model.LogFileListResult{})
  end
end
