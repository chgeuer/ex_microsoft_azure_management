...
defmodule Microsoft.Azure.Management.Database.MySql.Api.LogFiles do
  ...
  {:ok, %Microsoft.Azure.Management.Database.MySql.Model.LogFileListResult{}} on success
  {:error, info} on failure
  """
  @spec log_files_list_by_server(Tesla.Env.client, String.t, String.t, String.t, String.t, keyword()) :: {:ok, Microsoft.Azure.Management.Database.MySql.Model.LogFileListResult.t} | {:error, Tesla.Env.t}
  def log_files_list_by_server(connection, api_version, subscription_id, resource_group_name, server_name, _opts \\ []) do
    ...
    |> decode(%Microsoft.Azure.Management.Database.MySql.Model.LogFileListResult{})
  end
end
