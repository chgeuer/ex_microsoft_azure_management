...
defmodule Microsoft.Azure.Management.Database.MySql.Api.Configurations do
  @moduledoc """
  ...
  {:ok, %Microsoft.Azure.Management.Database.MySql.Model.Configuration{}} on success
  {:error, info} on failure
  """
  @spec configurations_create_or_update(Tesla.Env.client, String.t, String.t, String.t, String.t, String.t, Microsoft.Azure.Management.Database.MySql.Model.Configuration.t, keyword()) :: {:ok, Microsoft.Azure.Management.Database.MySql.Model.Configuration.t} | {:error, Tesla.Env.t}
  def configurations_create_or_update(connection, api_version, subscription_id, resource_group_name, server_name, configuration_name, parameters, _opts \\ []) do
    ...
    |> decode(%Microsoft.Azure.Management.Database.MySql.Model.Configuration{})
  end
  ...
  {:error, info} on failure
  """
  @spec configurations_get(Tesla.Env.client, String.t, String.t, String.t, String.t, String.t, keyword()) :: {:ok, Microsoft.Azure.Management.Database.MySql.Model.Configuration.t} | {:error, Tesla.Env.t}
  ...
  {:ok, %Microsoft.Azure.Management.Database.MySql.Model.ConfigurationListResult{}} on success
  {:error, info} on failure
  """
  @spec configurations_list_by_server(Tesla.Env.client, String.t, String.t, String.t, String.t, keyword()) :: {:ok, Microsoft.Azure.Management.Database.MySql.Model.ConfigurationListResult.t} | {:error, Tesla.Env.t}
  def configurations_list_by_server(connection, api_version, subscription_id, resource_group_name, server_name, _opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%Microsoft.Azure.Management.Database.MySql.Model.ConfigurationListResult{})
  end
end
