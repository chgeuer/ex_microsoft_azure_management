...
defmodule Microsoft.Azure.Management.ManagedServiceIdentity.Connection do
  @moduledoc """
  Handle Tesla connections for Microsoft.Azure.Management.ManagedServiceIdentity.
  """
