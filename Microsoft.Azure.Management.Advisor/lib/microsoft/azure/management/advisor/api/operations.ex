...
defmodule Microsoft.Azure.Management.Advisor.Api.Operations do
  ...
  {:ok, %Microsoft.Azure.Management.Advisor.Model.OperationEntityListResult{}} on success
  {:error, info} on failure
  """
  @spec operations_list(Tesla.Env.client, String.t, keyword()) :: {:ok, Microsoft.Azure.Management.Advisor.Model.OperationEntityListResult.t} | {:error, Tesla.Env.t}
  def operations_list(connection, api_version, _opts \\ []) do
    ...
    |> decode(%Microsoft.Azure.Management.Advisor.Model.OperationEntityListResult{})
  end
end
