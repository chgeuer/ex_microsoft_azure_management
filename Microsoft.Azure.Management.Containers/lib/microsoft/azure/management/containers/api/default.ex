...
defmodule Microsoft.Azure.Management.Containers.Api.Default do
  @moduledoc """
  ...
  {:ok, %Microsoft.Azure.Management.Containers.Model.UsageListResult{}} on success
  {:error, info} on failure
  """
  @spec container_group_usage_list(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, Microsoft.Azure.Management.Containers.Model.UsageListResult.t} | {:error, Tesla.Env.t}
  def container_group_usage_list(connection, subscription_id, location, api_version, _opts \\ []) do
    ...
    |> decode(%Microsoft.Azure.Management.Containers.Model.UsageListResult{})
  end
  ...
  {:ok, %Microsoft.Azure.Management.Containers.Model.ContainerGroup{}} on success
  {:error, info} on failure
  """
  @spec container_groups_create_or_update(Tesla.Env.client, String.t, String.t, String.t, String.t, Microsoft.Azure.Management.Containers.Model.ContainerGroup.t, keyword()) :: {:ok, Microsoft.Azure.Management.Containers.Model.ContainerGroup.t} | {:error, Tesla.Env.t}
  def container_groups_create_or_update(connection, subscription_id, api_version, resource_group_name, container_group_name, container_group, _opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%Microsoft.Azure.Management.Containers.Model.ContainerGroup{})
  end
  ...
  {:error, info} on failure
  """
  @spec container_groups_delete(Tesla.Env.client, String.t, String.t, String.t, String.t, keyword()) :: {:ok, Microsoft.Azure.Management.Containers.Model.ContainerGroup.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec container_groups_get(Tesla.Env.client, String.t, String.t, String.t, String.t, keyword()) :: {:ok, Microsoft.Azure.Management.Containers.Model.ContainerGroup.t} | {:error, Tesla.Env.t}
  ...
  {:ok, %Microsoft.Azure.Management.Containers.Model.ContainerGroupListResult{}} on success
  {:error, info} on failure
  """
  @spec container_groups_list(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, Microsoft.Azure.Management.Containers.Model.ContainerGroupListResult.t} | {:error, Tesla.Env.t}
  def container_groups_list(connection, subscription_id, api_version, _opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%Microsoft.Azure.Management.Containers.Model.ContainerGroupListResult{})
  end
  ...
  {:error, info} on failure
  """
  @spec container_groups_list_by_resource_group(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, Microsoft.Azure.Management.Containers.Model.ContainerGroupListResult.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec container_groups_update(Tesla.Env.client, String.t, String.t, String.t, String.t, Microsoft.Azure.Management.Containers.Model.Resource.t, keyword()) :: {:ok, Microsoft.Azure.Management.Containers.Model.ContainerGroup.t} | {:error, Tesla.Env.t}
  ...
  {:ok, %Microsoft.Azure.Management.Containers.Model.Logs{}} on success
  {:error, info} on failure
  """
  @spec container_logs_list(Tesla.Env.client, String.t, String.t, String.t, String.t, String.t, keyword()) :: {:ok, Microsoft.Azure.Management.Containers.Model.Logs.t} | {:error, Tesla.Env.t}
  def container_logs_list(connection, subscription_id, api_version, resource_group_name, container_group_name, container_name, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%Microsoft.Azure.Management.Containers.Model.Logs{})
  end
  ...
  {:ok, %Microsoft.Azure.Management.Containers.Model.ContainerExecResponse{}} on success
  {:error, info} on failure
  """
  @spec start_container_launch_exec(Tesla.Env.client, String.t, String.t, String.t, String.t, String.t, Microsoft.Azure.Management.Containers.Model.ContainerExecRequest.t, keyword()) :: {:ok, Microsoft.Azure.Management.Containers.Model.ContainerExecResponse.t} | {:error, Tesla.Env.t}
  def start_container_launch_exec(connection, subscription_id, api_version, resource_group_name, container_group_name, container_name, container_exec_request, _opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%Microsoft.Azure.Management.Containers.Model.ContainerExecResponse{})
  end
end
