...
defmodule Microsoft.Azure.Management.Preview.Advisor.Api.Suppressions do
  @moduledoc """
  ...
  {:ok, %Microsoft.Azure.Management.Preview.Advisor.Model.SuppressionContract{}} on success
  {:error, info} on failure
  """
  @spec suppressions_create(Tesla.Env.client, String.t, String.t, String.t, Microsoft.Azure.Management.Preview.Advisor.Model.SuppressionContract.t, String.t, keyword()) :: {:ok, Microsoft.Azure.Management.Preview.Advisor.Model.SuppressionContract.t} | {:error, Tesla.Env.t}
  def suppressions_create(connection, resource_uri, recommendation_id, name, suppression_contract, api_version, _opts \\ []) do
    ...
    |> decode(%Microsoft.Azure.Management.Preview.Advisor.Model.SuppressionContract{})
  end
  ...
  {:error, info} on failure
  """
  @spec suppressions_get(Tesla.Env.client, String.t, String.t, String.t, String.t, keyword()) :: {:ok, Microsoft.Azure.Management.Preview.Advisor.Model.SuppressionContract.t} | {:error, Tesla.Env.t}
  ...
  {:ok, [%SuppressionContract{}, ...]} on success
  {:error, info} on failure
  """
  @spec suppressions_list(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, list(Microsoft.Azure.Management.Preview.Advisor.Model.SuppressionContract.t)} | {:error, Tesla.Env.t}
  def suppressions_list(connection, subscription_id, api_version, _opts \\ []) do
    %{}
    |> method(:get)
