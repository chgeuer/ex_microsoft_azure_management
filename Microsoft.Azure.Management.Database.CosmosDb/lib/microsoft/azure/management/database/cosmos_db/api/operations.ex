...
defmodule Microsoft.Azure.Management.Database.CosmosDb.Api.Operations do
  @moduledoc """
  ...
  {:ok, %Microsoft.Azure.Management.Database.CosmosDb.Model.OperationListResult{}} on success
  {:error, info} on failure
  """
  @spec operations_list(Tesla.Env.client, String.t, keyword()) :: {:ok, Microsoft.Azure.Management.Database.CosmosDb.Model.OperationListResult.t} | {:error, Tesla.Env.t}
  def operations_list(connection, api_version, _opts \\ []) do
    ...
    |> decode(%Microsoft.Azure.Management.Database.CosmosDb.Model.OperationListResult{})
  end
end
