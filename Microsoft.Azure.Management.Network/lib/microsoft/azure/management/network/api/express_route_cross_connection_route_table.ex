...
defmodule Microsoft.Azure.Management.Network.Api.ExpressRouteCrossConnectionRouteTable do
  @moduledoc """
  API calls for all endpoints tagged `ExpressRouteCrossConnectionRouteTable`.
  """
  ...
  """
  @spec express_route_cross_connections_list_routes_table(Tesla.Env.client, String.t, String.t, String.t, String.t, String.t, String.t, keyword()) :: {:ok, Microsoft.Azure.Management.Network.Model.ExpressRouteCircuitsRoutesTableListResult.t} | {:error, Tesla.Env.t}
  def express_route_cross_connections_list_routes_table(connection, resource_group_name, cross_connection_name, peering_name, device_path, api_version, subscription_id, _opts \\ []) do
    %{}
    |> method(:post)
    |> url("/subscriptions/#{subscription_id}/resourceGroups/#{resource_group_name}/providers/Microsoft.Network/expressRouteCrossConnections/#{cross_connection_name}/peerings/#{peering_name}/routeTables/#{device_path}")
